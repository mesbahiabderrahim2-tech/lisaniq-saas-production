...
.from('projects')
.select(  id, name, description, color, created_at, updated_at,   datasets(id, name, file_name, file_type, row_count, file_size, status, created_at),   reports(id, name, health_score, business_status, is_starred, created_at)  )
.eq('id', id)
...
<SectionLabel num="01" label="Upload Dataset" />  <Card className="mb-8">  
...
<Card className="mb-8">  
  <div className="flex items-center justify-between gap-6 flex-wrap">  <div className="flex-1 min-w-[280px]">  
  <h3  
    className="text-[15px] font-semibold mb-1"  
    style={{ color: 'var(--platinum)' }}  
  >  
